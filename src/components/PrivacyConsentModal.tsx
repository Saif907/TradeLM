            ...
            <div className="space-y-4">
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    We use <strong>pseudonymous identifiers</strong> (random UUIDs) to store your trading data and chat history. 
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <ul className="text-sm text-muted-foreground space-y-1 list-disc list-inside">
                    <li><strong>Right to Access:</strong> Export all your data at any time</li>
                    <li><strong>Right to Erasure:</strong> Delete your account and all associated data</li>
                    <li><strong>Data Portability:</strong> Download your data in standard formats</li>
                    <li><strong>Consent Withdrawal:</strong> Revoke consent and delete all data</li>
                  </ul>
                </div>
              </div>
              ...
              <div className="bg-muted/50 p-4 rounded-lg">
                ...
                <p className="text-xs text-muted-foreground">
                  Our system is designed to comply with <strong>GDPR</strong> (General Data Protection Regulation), 
                  <strong> ISO/IEC 27001</strong> security principles, and the <strong>Indian DPDP Bill</strong> (Digital Personal Data Protection).
